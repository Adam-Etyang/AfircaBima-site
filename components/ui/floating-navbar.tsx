...
export const FloatingNav = ({
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        <div className="flex items-center justify-center gap-2 rounded-full border border-white/10 bg-[#111816] px-3 py-2.5 shadow-lg shadow-black/10 backdrop-blur-md dark:border-white/10">
          {/* Nav items container */}
          ...
          {/* CTA Button */}
          <button className="bg-[#c5d6c5] relative rounded-full px-4 py-2 text-sm font-medium text-white transition-all hover:bg-[#111816] hover:shadow-lg hover:shadow-neutral-900/20 ">
            <span>Login</span>
          </button>
        </div>
      </motion.div>
